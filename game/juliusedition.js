...
square[1] = new Square(
	...
	"Geburt 8. April 1883",
	1883,
	"https://richter.hostettler.cc/stationen/#8-april-1883"
);
...
square[3] = new Square(
	...
	"1901 bis 1903",
	"https://richter.hostettler.cc/stationen/#1901-1903-ausbildung-zum-dekorationsmaler-kunstgewerbeschule-dessau"
);
...
square[6] = new Square(
	...
	"1903",
	"https://richter.hostettler.cc/stationen/#1903-bleicherode-schmalkalden-sommerda",
);
...
square[8] = new Square(
	...
	"1904 bis 1906",
	"https://richter.hostettler.cc/stationen/#1904-1906-tivoli-theater-dessau",
);
square[9] = new Square(
	"Spremberg",
	"€120",
	...
	"1904 bis 1905",
	"https://richter.hostettler.cc/stationen/#1904-1905-forst-spremberg-landsberg",
);
...
square[11] = new Square(
	...
	"1905",
	"https://richter.hostettler.cc/stationen/#1905-sommertheater-kustrin"
);
...
square[13] = new Square(
	...
	"1906 bis 1910",
	"https://richter.hostettler.cc/stationen/#1906-1910-residenztheater-hannover"
);
square[14] = new Square(
	...
	"1910 bis 1913",
	"https://richter.hostettler.cc/stationen/#1910-1913-deutsches-theater-hannover"
);
...
square[16] = new Square(
	...
	"",
	"",
	"https://richter.hostettler.cc/stationen/#kurze-tatigkeit-bei-der-filmfabrik-agfa"
);
...
square[18] = new Square(
	...
	"1914",
	"https://richter.hostettler.cc/stationen/#1914-stadttheater-stettin"
);
...
square[21] = new Square(
	...
	"Kriegseinsatz",
	"1917",
	"https://richter.hostettler.cc/stationen/#1917-kriegseinsatz-in-frankreich"
);
...
square[23] = new Square(
	...
	"1917 bis 1919",
	"https://richter.hostettler.cc/stationen/#1917-1919-handforth-camp-theatre"
);
square[24] = new Square(
	...
	"Direktor Dr. George Altman",
	"1920 bis 1921",
	"https://richter.hostettler.cc/stationen/#1920-1921-kleines-theater-berlin"
);
...
square[26] = new Square(
	...
	"1921 bis 1925",
	"https://richter.hostettler.cc/stationen/#1921-1925-rotter-buhnen-berlin"
);
square[27] = new Square(
	...
	"1926 bis 1927",
	"https://richter.hostettler.cc/stationen/#1926-1927-barnowsky-buhnen-berlin",
);
...
square[29] = new Square(
	...
	"1927 bis 1928",
	"https://richter.hostettler.cc/stationen/#1927-1928-piscatorbuhnen"
);
...
square[31] = new Square(
	...
	"1929 bis 1936",
	"https://richter.hostettler.cc/stationen/#1929-1936-hessisches-landestheater-darmstadt",
);
square[32] = new Square(
	...
	"1936 bis 1939",
	"https://richter.hostettler.cc/stationen/#1936-1939-stadtische-buhnen-dusseldorf"
);
...
square[34] = new Square(
	...
	"1939 bis 1944",
	"https://richter.hostettler.cc/stationen/#1939-1944-theater-des-volkes"
);
...
square[37] = new Square(
	...
	"1945 bis 1959",
	"https://richter.hostettler.cc/stationen/#1945-1959-schlosspark-theater-berlin"
);
...
square[39] = new Square(
	...
	"1965",
	"https://richter.hostettler.cc/stationen/#4-juni-1965"
);
...
communityChestCards[12] = new Card("Du hast dein 40 jähriges Bühnenjubiläum", function() { collectfromeachplayer(10, 'Community Chest');});
...
chanceCards[2] = new Card("Investiere €15.", function() { subtractamount(15, 'Chance');});
chanceCards[3] = new Card("Gib jedem Spieler 50 €.", function() { payeachplayer(50, 'Chance');});
chanceCards[4] = new Card("Gehe drei Felder zurück.", function() { gobackthreespaces();});
...
chanceCards[6] = new Card("Du erhälst von der Bank €50 Zinsen.", function() { addamount(50, 'Chance');});
...
chanceCards[8] = new Card("Zahle 15€ Nachsteuer.", function() { subtractamount(15, 'Chance');});
chanceCards[9] = new Card("Take a trip to Vereinigte Privatbahnen. If you pass \"GO\" collect €200.", function() { advance(5);});
chanceCards[10] = new Card("ADVANCE to Berlin.", function() { advance(39);});
chanceCards[11] = new Card("ADVANCE to Kleines Theater Berlin. If you pass \"GO\" collect €200.", function() { advance(24);});
...
chanceCards[15] = new Card("Gehe direkt ins Gefängnis. Du gehtst dabei nicht über LOS und bekommst auch kein Geld.", function() { gotojail();});
